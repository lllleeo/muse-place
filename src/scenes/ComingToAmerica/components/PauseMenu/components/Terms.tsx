...
const TermsSubHeader = styled.h3`
  font-size: 1rem;
  text-align: left;
  margin: 0.1rem 0;
`;

const TermsHeader3 = styled.h4`
  font-size: 1rem;
  text-align: center;
  text-decoration: underline;
`;
...
const Terms = (props: { onClick: () => void }) => {
  return (
    <TermsMain>
      ...
      <TermsContent>
        Please review our Privacy Notice, which also governs your visit to the
      ...
      <TermsContent>
        ...
        software, is the property of Amazon or its content suppliers and
        protected by United States and international copyright laws. The
        compilation of all content on the Site is the exclusive property of
        Amazon and protected by U.S. and international copyright laws. All
        software used on the Site is the property of Amazon or its software
        suppliers and protected by United States and international copyright
        laws.
      </TermsContent>
      <TermsSubHeader>TRADEMARKS</TermsSubHeader>
      <TermsContent>
        AMAZON, AMAZON.COM, AMAZON STUDIOS, and other Site graphics, logos, page
        headers, button icons, scripts, and service names are trademarks,
        registered trademarks or trade dress of Amazon
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        in the U.S. and/or other countries. Amazon's trademarks and trade dress
        may not be used in connection with any product or
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        service that is not Amazon's, in any manner that is likely to cause
        confusion among customers, or in any manner that disparages or
        discredits Amazon. All other trademarks not owned by Amazon that appear
        on the Site are the property of their respective owners, who may or may
        not be affiliated with, connected to, or sponsored by Amazon.AMAZON,
        AMAZON.COM, AMAZON STUDIOS, and other Site graphics, logos, page
        headers, button icons, scripts, and service names are trademarks,
        registered trademarks or trade dress of Amazon in the U.S. and/or other
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        countries. Amazon's trademarks and trade dress may not be used
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        in connection with any product or service that is not Amazon's, in any
        manner that is likely to cause confusion among customers, or in any
        manner that disparages or discredits Amazon. All other trademarks not
        owned by Amazon that appear on the Site are the property of their
      ...
      <TermsContent>
        Amazon grants you a limited license to access and make personal use of
        the Site and not to download (other than page caching) or modify it, or
        any portion of it, except with express written consent of Amazon. Except
        with express written consent of Amazon, this license does not include
        any resale or commercial use of the Site or its contents; any derivative
        use of the Site or its contents; any downloading or copying of account
        information for the benefit of any other party; or any use of data
        mining, robots, or similar data gathering and extraction tools. The Site
        or any portion of the Site may not be reproduced, duplicated, copied,
        sold, resold, visited, or otherwise exploited for any commercial purpose
        without express written consent of Amazon. You may not frame or utilize
        framing techniques to enclose any trademark, logo, or other proprietary
        information (including images, text, page layout, or form) of Amazon
        without express written consent. You may not use any meta
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        tags or any other "hidden text" utilizing Amazon's name or trademarks
        without the express written consent of Amazon. Any unauthorized use
        terminates the permission or license granted by Amazon. You are granted
        a limited, revocable, and nonexclusive right to create a hyperlink to
        the Site so long as the link does not portray Amazon, or its products or
        services in a false, misleading, derogatory, or otherwise offensive
        matter. You may not use any Amazon logo or other proprietary graphic or
      ...
      <TermsContent>
        ...
        activities that occur under your account or password at any time. The
        Site is not available for use by children. You must be 18 to use the
        Site. Amazon reserves the right to refuse service, terminate accounts,
        and remove or edit content.
      </TermsContent>
      <TermsSubHeader>COPYRIGHT COMPLAINTS</TermsSubHeader>
      <TermsContent>
        Amazon respects the intellectual property of others. If you believe that
        your work has been copied in a way that constitutes copyright
        infringement, please follow our{" "}
      ...
      <TermsContent>
        Parties other than Amazon may make rights and services available on the
        Site. In addition, we provide links to the sites of affiliated companies
        and certain other businesses. We are not responsible for examining or
        evaluating, and we do not warrant the offerings of, any of these parties
        or the content of their Web sites. Amazon does not assume any
        responsibility or liability for the actions, product, and content of all
        these and any other third parties. You should carefully review their
      ...
      <TermsContent>
        THIS SITE AND ALL INFORMATION, CONTENT, MATERIALS, PRODUCTS (INCLUDING
        SOFTWARE) AND SERVICES INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU
        THROUGH THIS SITE ARE PROVIDED BY AMAZON ON AN
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        "AS IS" AND "AS AVAILABLE" BASIS, UNLESS OTHERWISE SPECIFIED IN WRITING.
        AMAZON MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR
        ...
        SPECIFIED IN WRITING. YOU EXPRESSLY AGREE THAT YOUR USE OF THIS SITE IS
        AT YOUR SOLE RISK. TO THE FULL EXTENT PERMISSIBLE BY APPLICABLE LAW,
        AMAZON DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT
        LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A
        PARTICULAR PURPOSE. AMAZON DOES NOT WARRANT THAT THIS SITE; INFORMATION,
        CONTENT, MATERIALS, PRODUCTS (INCLUDING SOFTWARE) OR SERVICES INCLUDED
        ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THIS SITE; THEIR SERVERS;
        OR E-MAIL SENT FROM AMAZON ARE FREE OF VIRUSES OR OTHER HARMFUL
        COMPONENTS. AMAZON WILL NOT BE LIABLE FOR ANY DAMAGES OF ANY KIND
        ...
        DAMAGES, UNLESS OTHERWISE SPECIFIED IN WRITING. CERTAIN STATE LAWS DO
      ...
      <TermsContent>
        <b>
          Any dispute or claim between you and Amazon relating in any way to
          your visit to the Site or to properties contributed to, developed on
          or distributed by or through the Site will be resolved by binding
          arbitration, rather than in court,
        </b>{" "}
        except that you may assert claims in small claims court if your claims
        qualify. The Federal Arbitration Act and federal arbitration law apply
        to this agreement.
        <b>
        ...
        WA 98051. The arbitration will be conducted by the American Arbitration
        ...
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        frivolous. Likewise, Amazon will not seek attorneys' fees and costs in
        ...
        <b>we each waive any right to a jury trial.</b> We also both agree that
      ...
      <TermsContent>
        By visiting the Site, you agree that the Federal Arbitration Act,
      ...
      <TermsContent>
        Please review our other agreements, rules and notices posted on the
        Site. These policies also govern your visit to the Site. We reserve the
        right to make changes to our Site, policies, and these Conditions of Use
        at any time. If any of these conditions is deemed invalid, void, or for
      ...
      <TermsContent>
        ...
        copyright infringement, please provide our copyright agent the written
        ...
        {/* eslint-disable-next-line react/no-unescaped-entities */}
        Amazon's Copyright Agent for notice of claims of copyright infringement
      ...
      <TermsContent>
        This website follows the same information practices as Amazon, and
