...
export const linkPositions = [
  {
    p: new Vector3(-1.4, 0.9, 0.115),
    r: Math.PI / 2,
  },
  {
    p: new Vector3(-1.62, 0.9, 0.115),
    r: -Math.PI / 2,
  },
  {
    p: new Vector3(-1.4, 0.9, 4.115),
    r: Math.PI / 2,
  },
  {
    p: new Vector3(-1.62, 0.9, 4.115),
    r: -Math.PI / 2,
  },
  {
    p: new Vector3(-1.4, 0.9, 8.115),
    r: Math.PI / 2,
  },
  {
    p: new Vector3(-1.62, 0.9, 8.115),
    r: -Math.PI / 2,
  },
];
